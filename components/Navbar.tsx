        ...
        <div className="hidden flex-1 items-center justify-between gap-6 lg:flex">
          ...
          <ul className="flex items-center gap-6 text-sm font-medium text-white">
            ...
            <li className="relative" ref={dropdownRef}>
              ...
              {fiisAberto && (
                <ul className="absolute left-0 top-full mt-2 w-48 rounded-lg bg-white py-2 text-[#020659] shadow-lg dark:bg-[#1D3D59] dark:text-white">
                  {SETORES.map((setor) => (
                    <li key={setor}>
                      <Link
      ...
      {menuAberto && (
        <div className="fixed inset-0 z-50 lg:hidden">
          <div
            ...
            aria-hidden="true"
          />
          <div className="absolute left-0 top-0 flex h-full w-72 max-w-[85vw] flex-col bg-white p-4 shadow-xl dark:bg-[#0d1b2e]">
            ...
            <ul className="flex flex-col gap-1 text-sm font-medium text-[#020659] dark:text-white">
              ...
              <li>
                ...
                {fiisSubmenuAberto && (
                  <ul className="ml-3 mt-1 flex flex-col gap-1 border-l border-gray-200 pl-3 dark:border-white/10">
                    {SETORES.map((setor) => (
                      <li key={setor}>
                        <Link
                          href={`/?setor=${encodeURIComponent(setor)}`}
      ...
      {perfilAberto && (
        <div className="fixed inset-0 z-50">
          <div
            ...
            aria-hidden="true"
          />
          <div className="absolute right-0 top-0 flex h-full w-80 max-w-[90vw] flex-col bg-white p-6 shadow-xl dark:bg-[#0d1b2e]">
            <div className="mb-6 flex items-center justify-between">
